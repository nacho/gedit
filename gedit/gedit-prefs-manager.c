...
gedit_prefs_manager_get_save_encoding (void)
{
	...
	if (strcmp (str, "GEDIT_SAVE_CURRENT_LOCALE_WHEN_POSSIBLE") == 0)
		res = GEDIT_SAVE_CURRENT_LOCALE_WHEN_POSSIBLE;
	else
	{
		if (strcmp (str, "GEDIT_SAVE_CURRENT_LOCALE_IF_USED") == 0)
			res = GEDIT_SAVE_CURRENT_LOCALE_IF_USED;
		else
...
gedit_prefs_manager_set_save_encoding (GeditSaveEncodingSetting se)
{
	...
	switch (se)
	{
		case GEDIT_SAVE_CURRENT_LOCALE_WHEN_POSSIBLE:
			str = "GEDIT_SAVE_CURRENT_LOCALE_WHEN_POSSIBLE";
			break;

		case GEDIT_SAVE_CURRENT_LOCALE_IF_USED:
			str = "GEDIT_SAVE_CURRENT_LOCALE_IF_USED";
			break;
