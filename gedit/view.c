		    ...
		    int length, int *pos, View *view)
{
	...
	*/
	gedit_undo_add (buffer, position, (position + length), INSERT, doc, view);
...
#ifdef ENABLE_SPLIT_SCREEN    	
	gedit_view_set_split_screen ( view, (gint) settings->splitscreen);
#endif
